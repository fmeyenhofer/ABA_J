...
//
//        Img<FloatType> img = ops.create().img(view);
//        Img<FloatType> img = ImgView.wrap(rai, new ArrayImgFactory<>());
//        IterableInterval<BitType> bw = ops.threshold().huang(img);
//        Img bwi = ops.create().img(bw);
